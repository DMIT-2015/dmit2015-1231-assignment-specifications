...
. Open IntelliJ IDEA and create a new project using the *Jakarta EE* module and change following settings:
 ...
 .. Location: `~/IdeaProjects/dmit2015-1231-assignment04`
...
. In the Java package `dmit2015.persistence`, 
you use either the *DMIT2015 Jakarta Persistence CRUD Repository* file template or the *DMIT2015 Jakarta Persistence Entity Repository* file template to create Jakarta Persistence for the entities (Location, Department, Employee, Job).
.. If you are using the *DMIT2015 Jakarta Persistence CRUD Repository* file template, complete the TODO in the `update` method. 
