...
. In the Java package `dmit2015.persistence`, use the *DMIT2015 Jakarta Persistence CRUD Repository* file template to create Jakarta Persistence for two of the entities (Location, Department, Employee, Job).
...
| Entity classes are generated by the checkpoint 1 date.
| 1
